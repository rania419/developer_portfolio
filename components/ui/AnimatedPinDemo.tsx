...
export function AnimatedPinDemo({ title, des, img, iconLists, link} :
    {id: number ; title: string; img: string; link: string; des: string; iconLists: string[]}) {
  return (
    <div className="sm:h-[30rem] h-[35rem] lg:h-[40rem] md:h-[40rem] w-full flex items-center justify-center ">
      <PinContainer
        title={link}
        href={link}
      >
